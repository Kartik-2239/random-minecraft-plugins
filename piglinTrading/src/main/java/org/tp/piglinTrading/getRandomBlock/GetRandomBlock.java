package org.tp.piglinTrading.getRandomBlock;
...
public class GetRandomBlock {
    private ArrayList<Material> blocks = new ArrayList<>(Arrays.asList(
    ...
    public Material getRandomMaterial(){
        ...
        return blocks.get(random.nextInt(blocks.toArray().length-1));
    }
    public Material getSureShotMaterial(){
        Random random = new Random();
        return sureBlocks.get(random.nextInt(sureBlocks.toArray().length-1));
    }
}
